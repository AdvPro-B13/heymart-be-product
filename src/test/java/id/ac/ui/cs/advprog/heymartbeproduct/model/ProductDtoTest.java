...
class ProductDtoTest {
    ...
    void testAllArgsConstructor() {
        ...
        ProductDto productDto = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg", categoryNames);
    ...
    void testToString() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
        ProductDto productDto2 = new ProductDto("2", "Product2", 200.0, "Description2", 20, "image2.jpg",
                categoryNames);
    ...
    void testEqualsAndHashCode() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames1);
        ProductDto productDto2 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames2);
        ProductDto productDto3 = new ProductDto("2", "Product2", 200.0, "Description2", 20, "image2.jpg",
                categoryNames2);
    ...
    void testEqualsWithDifferentId() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
        ProductDto productDto2 = new ProductDto("2", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
    ...
    void testEqualsWithDifferentName() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
        ProductDto productDto2 = new ProductDto("1", "Product2", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
    ...
    void testEqualsWithDifferentPrice() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
        ProductDto productDto2 = new ProductDto("1", "Product1", 200.0, "Description1", 10, "image1.jpg",
                categoryNames);
    ...
    void testEqualsWithDifferentDescription() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
        ProductDto productDto2 = new ProductDto("1", "Product1", 100.0, "Description2", 10, "image1.jpg",
                categoryNames);
    ...
    void testEqualsWithDifferentQuantity() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
        ProductDto productDto2 = new ProductDto("1", "Product1", 100.0, "Description1", 20, "image1.jpg",
                categoryNames);
    ...
    void testEqualsWithDifferentImage() {
        ...
        ProductDto productDto1 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image1.jpg",
                categoryNames);
        ProductDto productDto2 = new ProductDto("1", "Product1", 100.0, "Description1", 10, "image2.jpg",
                categoryNames);
